...
Em.I18n.translations = {
 ...
 'app.redirectIssuePopup.body': '对于单点登录,保证Knox Gateway 和Ambari服务器在同一主机或者子域上<br/>也可以使用Ambari本地用户登录<a href="{0}" target="_blank">{0}</a>',
 'app.loadingPlaceholder': '加载中...',
 'app.versionMismatchAlert.title': '服务器端和Web客户端版本不匹配',
 'app.versionMismatchAlert.body': "服务器端和Web客户端版本不匹配:<br> <br>Ambari 服务器: <strong>{0}</strong><br>Ambari Web 客户端: <strong>{1}</strong><br><br>这通常是升级Ambari之后,由于Ambari Web 客户端代码进行浏览器缓存刷新而出现的.<br>如果要让这条通知消失,通常是'按Ctrl + Shift+ R'（在OS X'为Cmd + Shift+ R'）.<br>彻底清除浏览器缓存后,并再次点击这个URL连接,如果你还能看到这条通知.<br>您必须解决此错误才能继续.", 'app.signout': '注销',
 'app.settings': '设置',
 'app.manageAmbari': '管理',
 'app.aboutAmbari': '关于',
 ...
 'common.persist.error': 'ambari服务器持续Web客户端状态错误:',
 'common.update.error': '从Ambari服务器上检索web客户端状态错误',
 'common.tags': '标签',
 'common.important': '重要',
 ...
 'popup.jdkValidation.body': ' {0} 堆栈需要的JDK是 {1} 但是 Ambari 的JDK配置是 {2}. 这可能导致您的集群运行错误或问题.',
 ...
 'login.error.bad.connection': '无法连接到 Ambari 服务. 证实Ambari服务器正在运行,你可以从这台机器到达Ambari服务器.',
 'titlebar.alerts.noAlerts': '没有警告',
 'graphs.noData.title': '没有数据',
 'graphs.noData.message': '没有可用数据',
 'graphs.noData.tooltip.title': '没有可用数据. Ambari标准服务可能没有安装或无法访问',
 ...
 'installer.controls.checkConnection.popover': '这一行动将检查{0}的主机和端口的可访问性,从Ambari Server主机',
 ...
 'installer.step1.selectUseRepoOptions.public.networkLost.popup.msg': 'Ambari无法访问公共资源库,可能由于没有互联网环境,无法使用公共资源库进行安装,您的选择是：',
 'installer.step1.selectUseRepoOptions.public.networkLost.popup.msg1': '确定你的主机可以访问互联网',
 'installer.step1.selectUseRepoOptions.public.networkLost.popup.msg2': '如果你使用网络代理,请参考Ambari文档查看配置Ambari使用代理',
 ...
 'installer.step2.automaticInstall.tooltip.content': 'Ambari会自动在每个主机上安装和注册Ambari代理集群.',
 ...
 'installer.step2.useSsh.tooltip.content': '这个<b> SSH私钥文件</b>是用于连接到目标主机集群中安装Ambari代理的SSH私钥.',
 ...
 'installer.step2.manualInstall.tooltip.content': '手动注册每个主机上的代理Ambari消除了对SSH的需要,并应继续在集群安装前进行.',
 'installer.step2.manualInstall.tooltip.content_no_ssh': '手动每台主机上注册Ambari代理应继续集群安装之前进行.',
 'installer.step2.manualInstall.popup.header': '继续进行之前',
 'installer.step2.manualInstall.popup.body': '必须在每台主机上安装代理Ambari你要在继续之前管理.',
 ...
 'installer.step2.bootStrap.error': '在主机上设置Ambari代理遇到错误.',
 'installer.step2.bootStrap.inProgress': '请稍候,正在建立Ambari代理在主机上。这可以根据主机数量需要几分钟.',
 ...
 'installer.step4.ambariMetricsCheck.popup.body': 'Ambari指标从集群中收集指标,并使其可用于Ambari。如果不安装Ambari Metrics服务,指标将无法从Ambari访问。你确定你想不Ambari指标继续?',
 ...
 'installer.step9.status.hosts.heartbeat_lost': 'Ambari代理没有在{0}主机上运行.',
 'installer.step9.host.heartbeat_lost': '主机心跳丢失',
 'installer.step9.host.heartbeat_lost_popup': '在主机上Ambari代理未检测到信号',
 ...
 'admin.authentication.form.method.database': '使用Ambari数据库来验证用户身份',
 ...
 'admin.kerberos.credentials.store.hint.not.supported': 'Ambari没有配置存储凭据',
 ...
 'admin.kerberos.credentials.remove.confirmation.body': '您即将从Ambari删除KDC证书。 你确定?',
 ...
 'admin.kerberos.wizard.step1.info.body': '欢迎来到Ambari安全向导。使用该向导在集群中启用Kerberos安全,让我们开始吧.',
 ...
 'admin.kerberos.wizard.step1.option.kdc.condition.1': 'Ambari服务器和集群主机对KDC和KDC管理主机进行网络接入.',
 'admin.kerberos.wizard.step1.option.kdc.condition.2': 'KDC管理手中的凭证.',
 'admin.kerberos.wizard.step1.option.kdc.condition.3': 'Java加密扩展（JCE）在Ambari服务器主机和集群中的所有主机上已建立.',
 ...
 'admin.kerberos.wizard.step1.option.manual.condition.3': 'Java加密扩展（JCE）已经建立在Ambari服务器主机和集群中的所有主机上',
 ...
 'admin.kerberos.wizard.step1.option.ad.condition.1': 'Ambari服务器和集群主机具有对域控制器的网络访问.',
 ...
 'admin.kerberos.wizard.step1.option.ad.condition.5': 'Java加密扩展（JCE）已建立在Ambari服务器主机和集群中的所有主机上.',
 ...
 'admin.kerberos.wizard.step1.option.ipa.condition.4': 'Java Cryptography Extensions (JCE)已经安装在Ambari服务器主机和集群中的所有主机上',
 ...
 'admin.kerberos.wizard.step5.moreInfoNonManual.body': '使用 <b>下载 CSV 按钮</b>, 你可以下载,其中包含将自动Ambari创建的 principal和keytabs列表的csv文件.',
 'admin.kerberos.wizard.step5.moreInfoManual.body': '重要提示：使用<b>下载CSV</b>按钮来获得<b>必要</b>的由Ambari启用Kerberos集群中的 principal和keytabs的列表。 <b>不要继续</b>,直到手动创建和分发的 principal和keytabs到集群主机.',
 ...
 'admin.rm_highAvailability.closePopup': '启用ResourceManager的HA向导正在进行中。您必须允许向导来完成Ambari是在可用状态。如果选择退出,则必须按照说明书的指示完成或恢复使ResourceManager的HA作为Ambari用户手册中记录。您确定要退出向导?',
 ...
 'admin.security.step1.body.header': '重要提示:在配置Ambari来管理您的支持Kerberos的集群之前  您必须在集群上执行以下手动步骤。一定要记录每个主机的密钥表文件和校长为每个Hadoop的服务的位置 这个信息是必需的,以便使用该向导。',
 ...
 'admin.security.status.error': '从Ambari服务器检索集群安全状态错误',
 ...
 'admin.serviceAutoStart.header.text': 'Ambari服务已经设置开机自动启动。每个服务可以配置启动所有组件、主节点和工作节点或者可选。',
 ...
 'admin.stackVersions.manageVersions.popup.body': '你即将离开<b>集群管理</b>的接口,并转到<b> Ambari管理</b>的接口。您可以通过跳转到信息中心链接, 在Ambari管理>集群 部分返回集群管理.',
 ...
 'services.service.delete.popup.warning': '<b>{0}</b>服务将被Ambari删除,所有配置和配置历史将丢失',
 ...
 'hosts.host.configs.save.note': '此配置是通过ambari在安装/删除{0}组件的主机上创建',
 ...
 'hosts.delete.popup.body.msg6': '要完全删除主机,使用ambari代理一步就可以了.',
 'hosts.delete.popup.body.msg7': '<b>WARNING!</b> {0} should be decommissioned first to prevent data loss.',
 'hosts.delete.popup.body.msg.unknownComponents': '该主机不会出现在线和Ambari通信,因为代理已丢失.',
